  ...
  const descargarPDFIndividual = (val) => {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ['INCIDENTE COCODE REPORTANTE', val.nombre_cocode ? `${val.nombre_cocode} (DPI: ${val.dpi_cocode || 'N/A'})` : (val.id_afiliado ? `ID #${val.id_afiliado}` : 'N/A')],
        ['TELÉFONO DEL COCODE', val.telefono_cocode || 'NO REGISTRADO'],
        ['CELULAR DEL COCODE', val.celular_cocode || 'NO REGISTRADO'],

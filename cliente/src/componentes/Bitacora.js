...
function Bitacora() {
  ...
  const descargarInformeGeneral = () => {
    ...
    doc.setFontSize(16);
    escribirLineaMembrete(doc, "JALAPA", 15, { maxWidth: 240 });
    
    doc.setFont("helvetica", "normal");
    doc.setFontSize(10);
    escribirLineaMembrete(doc, "REPORTE MAESTRO DE AUDITORÍA Y BITÁCORA DE SISTEMAS", 21, { maxWidth: 240 });
    escribirLineaMembrete(doc, `Fecha de Emisión: ${new Date().toLocaleString()} | Región: Jalapa | Vista: Página ${pagina}`, 26, { maxWidth: 240 });
  ...
  const descargarPDFIndividual = (reg) => {
    ...
    escribirLineaMembrete(doc, "COMPROBANTE DE AUDITORÍA INTERNA", 20);
    
    doc.setFont("helvetica", "normal");
    doc.setFontSize(9);
    doc.setTextColor(100, 100, 100);
    escribirLineaMembrete(doc, "SISTEMA DE REGISTROS DE OBRAS MUNICIPALES JALAPA 2024-2026", 25);
